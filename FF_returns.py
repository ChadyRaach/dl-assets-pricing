...
target_portfolio = "48_Industry_Portfolios_CSV"
start_month = dt.datetime(2013, 1, 1)
end_month = dt.datetime(2013, 8, 1)
target_data = extract_returns_data(target_portfolio, start_month, end_month)